...
net user iyanjr iyanjr /add >nul
net localgroup iyanjr iyanjr /add >nul
net user iyanjr /active:yes >nul
net user installer /delete
diskperf -Y >nul
sc config Audiosrv start= auto >nul
sc start audiosrv >nul
ICACLS C:\Windows\Temp /grant iyanjr:F >nul
ICACLS C:\Windows\installer /grant iyanjr:F >nul
...
echo Username: iyanjr
echo Password: iyanjr
